...
- [ ] 微题第二批 15 道（kp-007/029/004/030/031 × 单选/多选/判断）
- [ ] 4 道 short_answer 删除重制为单选（备份先行）
- [ ] 闪卡首批（5 KP × 3–5 卡，最小信息原则）走新配方入池
- [ ] scratch 走查（3091 隔离）：四模式可练、改名空态、聚焦隐藏/恢复、
      闪卡揭示自评全流程、session-end 卡片条目、第二批判分
- [ ] 真实池 apply（pool/backups 备份）+ demo 3082 重挂
- [ ] changelog（实现 + 内容）+ 归档本变更（flash-card spec 落 Purpose）
