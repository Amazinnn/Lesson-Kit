...
- Focus Map query: generated by `pool/scripts/query-focus-map.py`. It returns
  ...
  neighbors, simple clusters, and learner signals.
...
the knowledge guide view, the unified problem pool, the problem-set view, Focus
Map JSON queries, editable graph maintenance, and lightweight runtime guards
are working.
